...
export default function AdminPayrollPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-extrabold tracking-tight sm:text-3xl">Bảng công & lương giáo viên</h1>
        <p className="mt-1 text-muted-foreground">
          1 ca đã chấm = 1 công. Việc theo dõi ai đã chấm ca nào nằm ở trang{" "}
          <Link href="/admin/checkin" className="font-semibold text-brand-600 hover:underline">
            Check-in ca dạy
          </Link>{" "}
          — trang này chỉ tính tiền.
        </p>
      </div>
