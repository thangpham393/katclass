...
/**
 * KAT logo mark — "KAT" lettermark with blue K, red A, blue T,
 * plus a red book-curve underline. Inspired by KAT Education identity.
 */
        ...
        <div className="leading-tight">
          <div
            className={cn(
              ...
              inverted ? "text-white" : "text-blue-800",
            )}
          >
            KAT <span className="text-red-600">CLASS</span>
          </div>
          <div
            className={cn(
